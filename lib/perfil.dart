              ...
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Pedro Picapiedra', style: TextStyle(fontSize: 20, fontWeight: FontWeight.normal))
                    ],
                  ),
                ),
              ],
              ...
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Supervisor', style: TextStyle(fontSize: 20, fontWeight: FontWeight.normal))
                    ],
                  ),
                ),
              ],
